...
import { E as Check, O as ArrowRight, S as CreditCard, a as Stamp, g as Mail, k as ArrowLeft, l as ShieldAlert, p as PackageCheck, w as CircleCheck, y as FileUp } from "../_libs/lucide-react.mjs";
import { i as SiteHeader, r as SiteFooter } from "./router-CF6FJEW1.mjs";
import { t as workflows } from "./workflows-C-PLUic4.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/respond-to-notice-ByducA9k.js
...
function RespondToNotice() {
	...
	const [noticeName, setNoticeName] = (0, import_react.useState)("");
	const [agency, setAgency] = (0, import_react.useState)("");
							...
							children: [
								step === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
										...
										children: "Respond to an immigration notice"
									}),
								...
								step === 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										children: "Upload the notice when document processing is connected, or identify it here so the workflow can begin. Do not enter information you don't want to store."
									}),
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
												...
												children: "Notice name or reference *"
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
												className: "input-field",
												value: noticeName,
												onChange: (e) => setNoticeName(e.target.value),
												placeholder: "Example: USCIS notice received August 2026"
											})] }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
												className: "input-label",
												children: "Issuing agency"
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
												className: "input-field",
												value: agency,
												onChange: (e) => setAgency(e.target.value),
												placeholder: "USCIS, ICE, DOS, etc."
											})] }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
												className: "input-label",
								...
								step === 2 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Tip:" }), " Include dates, receipt numbers, case numbers, and any specific requests from the notice. The more specific you are, the better the draft will be."]
									})
								] }),
								step === 3 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
										className: "mt-3 text-2xl font-bold text-navy-600",
										style: { fontFamily: "var(--font-serif)" },
										children: "What do you want the correspondence to accomplish?"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-navy-400",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
										...
										placeholder: "Example: I want to provide the requested documents and explain why one item is missing."
									})
								] }),
								step === 4 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
										...
										placeholder: "Your editable draft will appear here."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldAlert, {
											size: 16,
											className: "shrink-0"
										}), " This draft was generated from your input. It is not legal advice. Review and edit carefully before proceeding."]
									})
								] }),
								...
								step === 6 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-navy-400",
										children: "Add only the documents you intend to send and verify that they match the instructions you are responding to."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								...
								step === 7 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-navy-400",
										children: "Enter the mailing address of the agency or recipient."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "mt-6 grid gap-4 sm:grid-cols-2",
										children: [
								...
								step === 8 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-navy-400",
										children: "All options include printing, paper, envelope, and postage. For immigration correspondence, we recommend certified mail for proof of delivery."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mt-6 grid gap-3 sm:grid-cols-2",
								...
								step === 9 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CreditCard, {
											size: 16,
											className: "shrink-0"
										}), " Secure checkout via Stripe is being connected. You will be able to pay with any major credit or debit card."]
									})
								] }),
								step === 10 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "mt-3 text-navy-400",
											children: "Your correspondence is being prepared for mailing. You'll receive a tracking number once it ships."
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
//#endregion
export { RespondToNotice as component };
