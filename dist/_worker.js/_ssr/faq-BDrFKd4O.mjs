...
//#region node_modules/.nitro/vite/services/ssr/assets/faq-BDrFKd4O.js
...
var categories = [
		...
		questions: [
			{
				...
				a: "No. Immigration Mail is a correspondence tool, not a law firm. We help you prepare and send documents — we do not provide legal advice, and the AI assistant never invents facts or legal conclusions."
			},
			{
				q: "What types of correspondence can I prepare?",
				a: "Responses to immigration notices, supporting document submissions with cover letters, and explanation letters. Each has a guided workflow."
			},
			{
	...
	},
	{
		...
		questions: [
			...
			},
			{
				...
				a: "Certified mail provides a USPS delivery record — your proof that the correspondence was mailed on time."
			}
		]
	},
	{
	...
	},
	{
		...
		questions: [{
			...
			a: "No. Immigration Mail is a document preparation and mailing service. We do not provide legal advice or representation."
		}, {
			q: "Can this replace an attorney?",
			a: "No. If your case involves complex legal questions, consult a qualified immigration attorney."
		}]
	}
];
function FAQPage() {
