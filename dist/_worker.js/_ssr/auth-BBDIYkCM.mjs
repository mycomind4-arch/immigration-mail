...
import { m as FileText, v as CircleCheck, x as ArrowRight } from "../_libs/lucide-react.mjs";
import { n as SiteHeader, t as SiteFooter } from "./site-footer-ByRHAPkj.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/auth-BBDIYkCM.js
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
									...
									style: { fontFamily: "var(--font-serif)" },
									children: "Your correspondence, organized and sent."
								}),
							...
							children: submitted ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								className: "flex gap-1 rounded-xl bg-navy-50 p-1",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									onClick: () => setTab("signup"),
									className: `flex-1 rounded-lg px-4 py-2 text-sm font-semibold transition ${tab === "signup" ? "bg-white text-navy-600 shadow-sm" : "text-navy-400"}`,
									children: "Get notified"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									onClick: () => setTab("signin"),
									className: `flex-1 rounded-lg px-4 py-2 text-sm font-semibold transition ${tab === "signin" ? "bg-white text-navy-600 shadow-sm" : "text-navy-400"}`,
									children: "Sign in"
								})]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mt-6",
								children: [tab === "signup" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										children: "Enter your email to be notified when accounts launch. We'll let you know as soon as you can sign up."
									}),
									...
									className: "mt-5 text-xs text-navy-300",
									children: [
