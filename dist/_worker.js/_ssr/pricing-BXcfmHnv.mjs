...
import { C as Clock, E as Check, O as ArrowRight, a as Stamp, c as ShieldCheck, g as Mail, p as PackageCheck, s as Shield } from "../_libs/lucide-react.mjs";
import { i as SiteHeader, r as SiteFooter } from "./router-CVx3ZisP.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/pricing-BXcfmHnv.js
...
var tiers = [
	...
	},
	{
		...
		features: [
			...
			"Recommended for immigration mail"
		],
		icon: ShieldCheck,
		featured: true
	},
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: tiers.map(({ type, price, desc, features, icon: Icon, featured }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: `card p-6 ${featured ? "ring-2 ring-gold-400" : ""}`,
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-4 text-4xl font-bold text-navy-600",
										style: { fontFamily: "var(--font-serif)" },
										children: price
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
										...
										className: `mt-6 w-full justify-center text-center ${featured ? "btn-gold" : "btn-primary"}`,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-12 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-sm text-navy-400",
							children: [
