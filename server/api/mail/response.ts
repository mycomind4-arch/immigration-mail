 ...
 *
 * This is the browser-return path (fallback to the Stripe webhook).
...
import { fulfillFromBrowserReturn } from "../../../src/platform/fulfillment-adapter";
...
export default defineEventHandler(async (event) => {
  ...
  // ── Ownership check against the stored intent ──────────────
